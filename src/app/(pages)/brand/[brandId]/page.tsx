                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 py-8">
                        ...
                        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-2">
                            <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600">
                                {brand.name}
                            </h1>
            ...
            <div className="container mx-auto py-12 px-4">
                ...
                {products.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-xl">
                        <h2 className="text-2xl font-semibold text-gray-600">No products available at the moment.</h2>
                        <p className="text-gray-500 mt-2">Check back later for new arrivals from {brand.name}.</p>
                    </div>
                )}
            </div>
        </div>
